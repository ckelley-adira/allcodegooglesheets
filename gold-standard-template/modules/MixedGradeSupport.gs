...
//
// USAGE:
// 1. Enable in SiteConfig_TEMPLATE.gs: features.mixedGradeSupport = true
// 2. Configure MIXED_GRADE_CONFIG for your site
// 3. Set SHEET_FORMAT based on your sheets (STANDARD or SANKOFA)
// 4. Module is auto-loaded when feature flag is enabled
// ═══════════════════════════════════════════════════════════════════════════
 ...
 * NOTE: This is now controlled by SITE_CONFIG.features.mixedGradeSupport
 * The constant below is for backward compatibility only
 * @deprecated Use isFeatureEnabled('mixedGradeSupport') instead
 */
const ENABLE_MIXED_GRADES = typeof isFeatureEnabled !== 'undefined' 
  ? isFeatureEnabled('mixedGradeSupport') 
  : true;
